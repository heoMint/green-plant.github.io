...
import { ContentItemsSet2 } from '../../context/data';
...
const SecondCard = () => {
  ...
  return (
    <S.BoxWrapper>
      {ContentItemsSet2.map(({ id, videoUrl, boxStyle, videoTitle }) => (
        <S.Box
          key={id}
          style={{
            ...boxStyle,
...
const S = {
  ...
  `,
  Box: styled.div`
    transition: transform 0.3s ease-in-out; // transform 변경 시 부드러운 애니메이션 적용
  `,
